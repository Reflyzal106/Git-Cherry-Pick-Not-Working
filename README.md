# [SOLVED] Git-Cherry-Pick-Not-Working
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/git-cherry-pick-not-working)
>
...
The issue is caused by unresolved conflicts during the cherry-pick process. To fix, use git commit --allow-empty to proceed with an empty commit.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/git-cherry-pick-not-working)**
